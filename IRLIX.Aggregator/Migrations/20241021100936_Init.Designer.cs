...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContractorEntityTariffEntity", b =>
                {
                    b.Property<Guid>("SelectedTariffContractorsId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("SelectedTariffsId")
                        .HasColumnType("uuid");

                    b.HasKey("SelectedTariffContractorsId", "SelectedTariffsId");

                    b.HasIndex("SelectedTariffsId");

                    b.ToTable("ContractorEntityTariffEntity");
                });
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Auth.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000001"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "210e5bd5-75ca-4425-9121-cc5bf3136651",
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "no-reply@shuttlex.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "NO-REPLY@SHUTTLEX.COM",
                            NormalizedUserName = "F0535436-9946-4B24-8CB1-9024363EF475",
                            PhoneNumber = "",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "4c2c6167-c633-4468-a762-9a7cd012c6cc",
                            TwoFactorEnabled = false,
                            UpdatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            UserName = "f0535436-9946-4b24-8cb1-9024363ef475"
                        });
                });
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Config.PolygonGeoEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Config.ZoneEntity", b =>
                {
                    ...
                    b.Property<TimeSpan>("ContractorWorkDuringDayMaxTime")
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Docs.DocUploadedBlobEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Rides.Contractor.ContractorGeoEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Rides.TariffEntity", b =>
                {
                    ...
                    b.Property<decimal>("ScheduledTripMinimumPenalty")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Rides.TariffHierarchy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.WebMapping.FoundPlaceEntityML", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ContractorEntityTariffEntity", b =>
                {
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.Rides.Contractor.ContractorEntity", null)
                        .WithMany()
                        .HasForeignKey("SelectedTariffContractorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.Rides.TariffEntity", null)
                        .WithMany()
                        .HasForeignKey("SelectedTariffsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Config.ZoneEntity", b =>
                {
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.Config.ZoneEntity", "ParentEntity")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Docs.DocEntity", b =>
                {
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.Docs.DocMetadataEntity", "DocMetadata")
                        .WithMany()
                        .HasForeignKey("DocMetadataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DocMetadata");
                });
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Rides.Contractor.ContractorEntity", b =>
                {
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.Auth.UserEntity", "User")
                        .WithOne("Contractor")
                        .HasForeignKey("ShuttleX.Aggregator.Ef.Entities.Rides.Contractor.ContractorEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.Config.ZoneEntity", null)
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Rides.Contractor.ContractorStatEntity", b =>
                {
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.Rides.Contractor.ContractorEntity", "Contractor")
                        .WithOne("Statistic")
                        .HasForeignKey("ShuttleX.Aggregator.Ef.Entities.Rides.Contractor.ContractorStatEntity", "ContractorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Rides.Passenger.PassengerEntity", b =>
                {
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.Auth.UserEntity", "User")
                        .WithOne("Passenger")
                        .HasForeignKey("ShuttleX.Aggregator.Ef.Entities.Rides.Passenger.PassengerEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
