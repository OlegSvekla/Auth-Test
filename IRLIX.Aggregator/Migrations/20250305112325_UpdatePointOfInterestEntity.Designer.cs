...
namespace ShuttleX.Aggregator.Migrations
{
    ...
    [Migration("20250305112325_UpdatePointOfInterestEntity")]
    partial class UpdatePointOfInterestEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.PointOfInterest.PointOfInterestCategoryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.PointOfInterest.PointOfInterestEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("BackgroundGradientColor")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.PointOfInterest.PointOfInterestPhotoBlobEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PointOfInterestPhotoBlobs");
                });

            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.PointOfInterest.PointOfInterestToVodVideoLinqEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("PointOfInterestCategoryId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("VideoOnDemandId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("PointOfInterestCategoryId");

                    b.HasIndex("PointOfInterestId");

                    b.HasIndex("VideoOnDemandId");

                    b.ToTable("PointOfInterestToVodVideoLinqs");
                });
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.VideoOnDemandBlobEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("VideoOnDemandBlobs");
                });

            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.VideoOnDemandEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("VideoOnDemandBlobId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("VideoOnDemandBlobId")
                        .IsUnique();

                    b.ToTable("VideoOnDemands");
                });
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.PointOfInterest.PointOfInterestPhotoBlobEntity", b =>
                {
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.PointOfInterest.PointOfInterestEntity", "PointOfInterest")
                        .WithMany("PointOfInterestPhotoBlobs")
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.PointOfInterest.PointOfInterestToVodVideoLinqEntity", b =>
                {
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.PointOfInterest.PointOfInterestCategoryEntity", "PointOfInterestCategory")
                        .WithMany("PointOfInterestToVodVideoLinqs")
                        .HasForeignKey("PointOfInterestCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.VideoOnDemandEntity", "VideoOnDemand")
                        .WithMany("PointOfInterestToVodVideoLinqs")
                        .HasForeignKey("VideoOnDemandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PointOfInterest");

                    b.Navigation("PointOfInterestCategory");

                    b.Navigation("VideoOnDemand");
                });
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.VideoOnDemandEntity", b =>
                {
                    ...
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.VideoOnDemandBlobEntity", "VideoOnDemandBlob")
                        .WithOne("VideoOnDemand")
                        .HasForeignKey("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.VideoOnDemandEntity", "VideoOnDemandBlobId");

                    b.Navigation("Profile");

                    b.Navigation("VideoOnDemandBlob");
                });
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.PointOfInterest.PointOfInterestCategoryEntity", b =>
                {
                    b.Navigation("PointOfInterestToVodVideoLinqs");
                });

            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.PointOfInterest.PointOfInterestEntity", b =>
                {
                    b.Navigation("PointOfInterestPhotoBlobs");
