...
namespace ShuttleX.Aggregator.Migrations
{
    ...
    [Migration("20241129095541_AddAddressesInOrderAndUpdatedDateInProfileGeo")]
    partial class AddAddressesInOrderAndUpdatedDateInProfileGeo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Auth.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000001"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c5f6453f-3b51-425a-aee5-2ca272067159",
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "no-reply@shuttlex.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "NO-REPLY@SHUTTLEX.COM",
                            NormalizedUserName = "DD36E3E9-EE90-45E5-8515-B02FFBB8286C",
                            PhoneNumber = "",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "8e40e132-65da-4bdb-b865-8e77455292c4",
                            TwoFactorEnabled = false,
                            UpdatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            UserName = "dd36e3e9-ee90-45e5-8515-b02ffbb8286c"
                        });
                });
