...
namespace ShuttleX.Aggregator.Migrations
{
    ...
    [Migration("20250304163152_AddAiEntity")]
    partial class AddAiEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.PointOfInterestCategoryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.PointOfInterestEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.PointOfInterestPhotoBlobEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.TranscodeVideoBlobEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TranscodeVideoBlobs");
                });

            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.VideoToMapPointLinqEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("VideoManifestBlobId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("VideoManifestBlobId");

                    b.ToTable("VideoToMapPointLinqs");
                });
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.PointOfInterestPhotoBlobEntity", b =>
                {
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.PointOfInterestEntity", "PointOfInterest")
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.VideoToMapPointLinqEntity", b =>
                {
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.PointOfInterestCategoryEntity", "PointOfInterestCategory")
                        .WithMany("VideoToMapPointLinks")
                    ...
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.TranscodeVideoBlobEntity", "VideoManifestBlob")
                        .WithMany("VideoToMapPointLinks")
                        .HasForeignKey("VideoManifestBlobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("VideoManifestBlob");
                });
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.VideoStreaming.PointOfInterestCategoryEntity", b =>
                {
                    b.Navigation("VideoToMapPointLinks");
                });
