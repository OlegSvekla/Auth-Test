...
namespace ShuttleX.Aggregator.Migrations
{
    ...
    [Migration("20241128075650_AddProfileVehicleConnecting")]
    partial class AddProfileVehicleConnecting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Auth.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000001"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0ca4c72e-13b1-4215-a4ac-725f38d36b51",
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "no-reply@shuttlex.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "NO-REPLY@SHUTTLEX.COM",
                            NormalizedUserName = "71DA9479-C9DA-411C-A3FD-3B8C1752AA2A",
                            PhoneNumber = "",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "ef691fba-d4d2-4fed-9ae9-a8e9b99e067c",
                            TwoFactorEnabled = false,
                            UpdatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            UserName = "71da9479-c9da-411c-a3fd-3b8c1752aa2a"
                        });
                });
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Profile.ProfileVehicleEntity", b =>
                {
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.Profile.ProfileVehicleEntity", "ContractorVehicle")
                        .WithMany()
                        .HasForeignKey("ContractorVehicleId");
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Rides.Contractor.ContractorVehicleEntity", b =>
                {
                    ...
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.Profile.ProfileVehicleEntity", "ProfileVehicle")
                        .WithMany()
                        .HasForeignKey("ProfileVehicleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
