...
namespace ShuttleX.Aggregator.Migrations
{
    ...
    [Migration("20250328125552_AddChatAvatarEntity")]
    partial class AddChatAvatarEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Pois.PoiCategoryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Pois.PoiToVodLinqEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PoiCategoryId");

                    b.HasIndex("PoiId");

                    b.HasIndex("VodId");

                    b.ToTable("PoiToVodLinqs");
                });
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Pois.PoiToVodLinqEntity", b =>
                {
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.Pois.PoiCategoryEntity", "PoiCategory")
                        .WithMany("PointOfInterestToVodVideoLinqs")
                        .HasForeignKey("PoiCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
