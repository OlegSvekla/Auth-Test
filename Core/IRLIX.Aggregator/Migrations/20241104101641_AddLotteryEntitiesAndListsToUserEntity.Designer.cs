...
namespace ShuttleX.Aggregator.Migrations
{
    ...
    [Migration("20241104101641_AddLotteryEntitiesAndListsToUserEntity")]
    partial class AddLotteryEntitiesAndListsToUserEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Auth.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000001"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6027e93a-0f3a-4ee1-87dd-038d0d6abcce",
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "no-reply@shuttlex.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "NO-REPLY@SHUTTLEX.COM",
                            NormalizedUserName = "EE2A2D78-8B39-42F2-BEEA-2B81018D7949",
                            PhoneNumber = "",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "720bbe82-d55b-4b8f-8ff0-3b56a335ecf1",
                            TwoFactorEnabled = false,
                            UpdatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            UserName = "ee2a2d78-8b39-42f2-beea-2b81018d7949"
                        });
                });
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Lottery.PrizeEntity", b =>
                {
                    ...
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.Auth.UserEntity", "Winner")
                        .WithMany("Prizes")
            ...
            modelBuilder.Entity("ShuttleX.Aggregator.Ef.Entities.Lottery.TicketEntity", b =>
                {
                    ...
                    b.HasOne("ShuttleX.Aggregator.Ef.Entities.Auth.UserEntity", "Owner")
                        .WithMany("Tickets")
